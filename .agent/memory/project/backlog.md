...
- [ ] **Phase A next: A5 Seed Sanity from `lib/data/`** — author `scripts/seed-sanity.ts` to push existing TS modules (21 societies, board, partners, events) into Sanity via `@sanity/client`. Gate: `/studio` shows all seed docs.
