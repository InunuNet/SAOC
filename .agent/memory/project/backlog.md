...
_Last compacted: 2026-06-24 by session. Dismissed: 4× quota-monitor, 3× qa-guard, 9× check_own_comms pulse — all informational, no action required. Full history: git log on this file._
