...
_Last compacted: 2026-06-23 by session. Dismissed: 3× quota-monitor, 2× qa-guard, 8× check_own_comms pulse — all informational, no action required. Full history: git log on this file._
