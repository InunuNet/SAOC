...
_Last compacted: 2026-06-24 by session. Dismissed: 8× quota-monitor, 7× qa-guard, 22× check_own_comms pulse — all informational, no action required. Full history: git log on this file._
