...
- id: F1
  ...
  title: Remove the "venue changed" narrative framing from scripts/seed-show-visitor-info.ts,
    its golden copy-source JSON, the live Sanity showVisitorInfo document (via a one-off patch
    script), and the one dev-facing doc quoting it verbatim. Full spec:
    contracts/golden/venue-never-changed-copy-fix-f1/README.md.
  inline_brief: null
