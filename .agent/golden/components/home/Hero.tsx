...
export function Hero({ images }: HeroProps) {
  ...
  return (
    <section className="relative min-h-[720px] flex items-center overflow-hidden bg-primary on-dark">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-gradient-to-b from-primary/50 via-primary/60 to-primary/85"
      />
      ...
      <div className="relative z-10 w-full px-8 md:px-16 py-24 flex flex-col items-center text-center max-w-[1280px] mx-auto">
        ...
        <div className="flex flex-wrap gap-4 justify-start mb-10">
          <Link
            href="/societies"
            className="font-sans text-[14px] font-medium bg-primary text-ivory px-6 py-3 hover:bg-primary-800 transition-colors duration-150"
          >
            Find Your Society →
          </Link>
          <Link
