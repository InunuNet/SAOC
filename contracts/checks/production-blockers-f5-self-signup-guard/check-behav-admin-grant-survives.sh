#!/usr/bin/env bash
# A-BEHAV-02 — runs positive-path.mjs under the Firebase Auth + Functions emulator. Never
...
firebase emulators:exec \
  ...
  --only auth,functions \
  "node contracts/checks/production-blockers-f5-self-signup-guard/positive-path.mjs"
