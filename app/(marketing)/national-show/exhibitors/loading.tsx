// Route-level Suspense fallback while the Sanity exhibitor content loads.
// Sage & Paper tokens only, no new colours.
export default function ExhibitorInfoLoading() {
  return (
    <div className="mx-auto max-w-[1280px] space-y-6 px-8 py-16" aria-busy="true" aria-live="polite">
      ...
      <span className="sr-only">Loading exhibitor information…</span>
    </div>
  );
}
